...
#ifndef _eoOneMachineStat_h
#define _eoOneMachineStat_h
 ...
 */
template <class EOT>
class eoOneMachineStat : public eoStat<EOT, double>
{
public :
...
// START eventually add or modify the anyVariable argument
   ...
   */
  eoOneMachineStat(std::string _description = "eoOneMachineStat ") :
...
// END eventually add or modify the anyVariable argument
  ...
  virtual std::string className(void) const { return "eoOneMachineStat"; }
private :
// START Private data of an eoOneMachineStat object
  //  varType anyVariable;		   // for example ...
// END   Private data of an eoOneMachineStat object
};
